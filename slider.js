...
//         li.classList.add('slider-pagi__elem-'+i).data('page', i);
...
//       document.querySelectorAll(".slider-control").classList.remove("inactive");
//       if (!curSlide) document.querySelector(".slider-control.left").classList.add("inactive");
//       if (curSlide === numOfSlides) document.querySelector(".slider-control.right").classList.add("inactive");
//     };
...
//         slider.css("top");
//         document.querySelectorAll(".slide").classList.add("active");
...
//       document.querySelectorAll(".slider-pagi__elem").classList.remove("active");
...
//       sliderBGs.style.transform = "translate3d("+ -curSlide*50 +"%,0,0)";
